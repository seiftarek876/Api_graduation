                    ...
                    <form method="POST" action="{{route('admins.update', $admins->id)}}">
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            <div class="w-full">
                                ...
                                <x-text-input value="{{old('name' , $admins->name)}}" class="w-full" name="name"></x-text-input>
                                @error('name')
                              ...
                              <div class="w-full">
                                ...
                                <x-text-input value="{{old('email' ,$admins->email)}}" class="w-full" name="email"></x-text-input>
                                @error('email')
                                <p class="text-red-600 font-bold">{{$message}}</p>
                                @enderror
                            </div>
                              <div class="w-full">
                                ...
                                <x-text-input value="{{old('phone', $admins->phone)}}" class="w-full" name="phone"></x-text-input>
                                @error('phone')
                                <p class="text-red-600 font-bold">{{$message}}</p>
                                @enderror
                            </div>
