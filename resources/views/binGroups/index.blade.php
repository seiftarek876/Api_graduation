        ...
        <div class="max-w-full mx-auto sm:px-3 lg:px-4">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="flex justify-center m-3">
                    <x-button-link>
                        Add New Group
                        <x-slot name="href">{{route('binGroups.create')}}</x-slot>
                    </x-button-link>
                </div>
                {{-- {{dd($bins)}} --}}
                                ...
                                <table class="min-w-full">
                                    ...
                                    @forelse($groups as $key=> $group)
                                        <tr class="bg-white border-b text-center transition duration-300 ease-in-out hover:bg-gray-100">
                                            ...
                                            <td class="text-sm text-gray-900 font-bold px-6 py-4 whitespace-nowrap">
                                                {{date_format(date_create($group->created_at),'Y-m-d h:i:s a')}}
                                            </td>
                                            <td>
                                                <div class="flex justify-evenly">
                                                    <div>
                                                        <a href="{{route('binGroups.edit',$group->id)}}"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 50 50">
                                                    ...
                                                    <div>
                                                        <form method="post"
                                                              action="{{route('binGroups.destroy',$group->id)}}">
                                                            @method('DELETE')
                                                            @csrf
